<template>
  <div class="container">
    <el-button round @click="addStudentdrawer">增加学生</el-button>
    <div class="table">
      <el-table
        :data="tableData"
        border
    ...
    <el-drawer
      ...
      <el-form :model="InfoForm" ref="InfoForm" label-width="100px">
        ...
        <el-form-item>
          ...
          <el-button round @click="deleteInfo">删除学生</el-button>
        </el-form-item>
      </el-form>
    </el-drawer>
    <!--    增加学生-->
    <el-drawer
      ...
      <el-form :model="newForm" ref="newForm" label-width="100px">
        ...
        <el-form-item>
          <el-button round @click="addstudent">增加学生</el-button>
        </el-form-item>
      </el-form>
    </el-drawer>
  </div>
